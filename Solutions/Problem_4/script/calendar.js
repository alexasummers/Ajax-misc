...
function show_details(id) {
    var details={Name:$(id).attr("data-name"),StartDate:$(id).attr("data-date"),Duration:$(id).attr("data-duration")};
    var detail_template=$("#event-detail-template").html();
    var html_maker=new htmlMaker(detail_template);
    var html=html_maker.getHTML(details);
    $("#details").html(html);
